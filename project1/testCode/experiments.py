...
# f.write(stats.describe(easy_genetic_algorithm_results))
# f.write(stats.describe(easy_genetic_algorithm_iterations))
...
# f.write(stats.describe(med_genetic_algorithm_results))
# f.write(stats.describe(med_genetic_algorithm_iterations))
...
# f.write(stats.describe(hard_genetic_algorithm_results))
# f.write(stats.describe(hard_genetic_algorithm_iterations))

f.write("Evil Results\n")
...
# f.write(stats.describe(evil_genetic_algorithm_results))
# f.write(stats.describe(evil_genetic_algorithm_iterations))
